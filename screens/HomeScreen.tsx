    ...
    <ThemedView style={styles.container}>
      <ScreenScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.welcomeContainer}>
          ...
          >
            <Feather name="check-circle" size={48} color={AppColors.primary} />
          </View>
          <ThemedText style={styles.welcomeTitle}>
            Bienvenue sur Tyeb Liya
          </ThemedText>
          <ThemedText style={styles.welcomeSubtitle} type="small">
            Connecté en tant que {user?.pseudo || user?.email}
          </ThemedText>
        </View>
        ...
        <View style={styles.placeholderContainer}>
          <Feather name="coffee" size={32} color={AppColors.gray600} />
