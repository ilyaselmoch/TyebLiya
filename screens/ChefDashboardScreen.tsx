...
// Chef/Cuisinier dashboard - displayed for users with "cuisinier" role
    ...
    <ThemedView style={styles.container}>
      <ScreenScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.welcomeContainer}>
          ...
          >
            <Feather name="menu" size={48} color={AppColors.primary} />
          </View>
          <ThemedText style={styles.welcomeTitle}>
            Bienvenue, Chef {user?.pseudo}
          </ThemedText>
        ...
        <View style={styles.infoCard}>
          ...
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoContent}>
              ...
              <ThemedText style={styles.infoValue}>
                {user?.role === "cuisinier" ? "Cuisinier" : "Non attribué"}
              </ThemedText>
            </View>
          </View>
        </View>

        {/* Placeholder for future chef features */}
        <View style={styles.placeholderContainer}>
          <Feather name="sliders" size={32} color={AppColors.gray600} />
          <ThemedText style={styles.placeholderText} type="small">
            Tableau de bord cuisinier en développement...
          </ThemedText>
        </View>
